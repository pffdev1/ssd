...
export default function HomeScreen() {
  ...
  const visibleRequestTypes = useMemo(() => {
    ...
    return catalog.requestTypes.filter(
          ...
          <View style={{ flexDirection: isWide ? "row" : "column", gap: 12 }}>
            ...
            >
              ...
              <View style={{ marginTop: 12, flexDirection: "row", gap: 8, flexWrap: "wrap" }}>
                <Pressable onPress={() => router.push("/(tabs)/catalogo")} style={{ borderRadius: 999, backgroundColor: "#1e3a5f", paddingHorizontal: 16, paddingVertical: 10 }}>
                  <Text style={{ color: "white", fontWeight: "700" }}>Ir al catalogo</Text>
                </Pressable>
                <Pressable onPress={() => router.push("/(tabs)/inbox")} style={{ borderRadius: 999, borderWidth: 1, borderColor: "#bfd2e7", backgroundColor: "white", paddingHorizontal: 16, paddingVertical: 10 }}>
          ...
          <View style={{ flexDirection: isWide ? "row" : "column", gap: 12 }}>
            ...
            >
              <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: 8 }}>
                ...
                <Pressable onPress={() => router.push("/(tabs)/catalogo")}>
