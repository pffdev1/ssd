...
import { Image, Pressable, SafeAreaView, ScrollView, Text, TextStyle, View, ViewStyle, useWindowDimensions } from "react-native";
...
function isHomeActive(pathname: string) {
  return pathname === "/" || pathname === "/(tabs)" || pathname === "/(tabs)/home" || pathname === "/home";
}
...
function isRequestsActive(pathname: string) {
  return (
    ...
    pathname.startsWith("/(tabs)/requests") ||
...
function isAccountActive(pathname: string) {
  return (
    ...
    pathname.startsWith("/(tabs)/admin")
  );
}
  ...
  useEffect(() => {
    ...
    async function loadMenuData() {
      ...
      try {
        ...
        const filteredRequestTypes = filterRequestTypesForUser(catalog.requestTypes, currentUser);
        ...
        >
            ...
            <View style={{ marginTop: 10, alignItems: "flex-end", zIndex: 40 }}>
              ...
              >
                <Pressable
                  ...
                  style={{
                    borderRadius: 12,
                    backgroundColor: pathname.startsWith("/perfil") || pathname.startsWith("/profile") ? "#e9f2ff" : "white",
                ...
                {isAdmin ? (
                  <Pressable
                    ...
                    style={{
                      borderRadius: 12,
                      backgroundColor: pathname.startsWith("/admin") ? "#e9f2ff" : "white",
                      paddingHorizontal: 12,
                      paddingVertical: 10
                    }}
                  >
          ...
          <View style={{ marginTop: 12, flexDirection: "row", flexWrap: "wrap", gap: 8, zIndex: 35 }}>
            ...
            >
              ...
              <Text style={navTextStyle(inboxActive)}>Bandeja {inboxCount > 0 ? `(${unreadLabel})` : ""}</Text>
            </Pressable>
          </View>
